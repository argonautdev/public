...
export const V1EnvironmentApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {boolean} [elasticsearch] includes elasticsearch in response body if true
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        listResourcesInEnvironment: async (environmentName: string, rds?: boolean, eks?: boolean, s3Bucket?: boolean, elasticache?: boolean, elasticsearch?: boolean, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'environmentName' is not null or undefined
            ...
            if (elasticsearch !== undefined) {
                localVarQueryParameter['elasticsearch'] = elasticsearch;
            }
...
export const V1EnvironmentApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async listResourcesInEnvironment(environmentName: string, rds?: boolean, eks?: boolean, s3Bucket?: boolean, elasticache?: boolean, elasticsearch?: boolean, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IntegrationsAwsResources>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.listResourcesInEnvironment(environmentName, rds, eks, s3Bucket, elasticache, elasticsearch, options);
            return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
        },
        /**
         * Removes the resource folder from the github repo used to manage the hcl configs. This will trigger a workflow (which will fail since the required params won\'t be found in the commit message). NOTE: **This must be called after successful destruction of the resource, as resource existance is not checked here**
...
export const V1EnvironmentApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        listResourcesInEnvironment(environmentName: string, rds?: boolean, eks?: boolean, s3Bucket?: boolean, elasticache?: boolean, elasticsearch?: boolean, options?: any): AxiosPromise<IntegrationsAwsResources> {
            return localVarFp.listResourcesInEnvironment(environmentName, rds, eks, s3Bucket, elasticache, elasticsearch, options).then((request) => request(axios, basePath));
        },
        /**
         * Removes the resource folder from the github repo used to manage the hcl configs. This will trigger a workflow (which will fail since the required params won\'t be found in the commit message). NOTE: **This must be called after successful destruction of the resource, as resource existance is not checked here**
         * @summary Removes the resource folder from argonaut_terraform_configs
...
export class V1EnvironmentApi extends BaseAPI {
    ...
    public listResourcesInEnvironment(requestParameters: V1EnvironmentApiListResourcesInEnvironmentRequest, options?: any) {
        return V1EnvironmentApiFp(this.configuration).listResourcesInEnvironment(requestParameters.environmentName, requestParameters.rds, requestParameters.eks, requestParameters.s3Bucket, requestParameters.elasticache, requestParameters.elasticsearch, options).then((request) => request(this.axios, this.basePath));
    }
